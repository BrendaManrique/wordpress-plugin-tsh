<?php
	...
	$a = "SELECT clockYear FROM timeclock WHERE empId = ".$empId." GROUP BY clockYear";
...
<div class="content">
	...
	?>
				...
				<?php
					...
					$i = "SELECT weekNo FROM timeclock WHERE empId = ".$empId." AND clockYear = ".$year." GROUP BY weekNo ORDER BY weekNo DESC";
